            ...
            <div id="cart" class="main">
                ...
                <div class="main-body">
                    ...
                    <div class="product-label">
                        <img width="72" src="https://hpdx.hypedx.com.br/assets/images/products/<?php echo $imgs[0]; ?>" alt=""> 
                        ...
                        <h2 style="width: 26px !important;"><a style="text-decoration: none; font-size: 18px; color:black;" href="javascript:remove(<?php echo $prod['id']; ?>)">&times;</a></h2>
                        ...
                        <input onkeydown="checkForm();" placeholder="Apartamento 212 bloco A" type="text" name="" id="compl">
                            ...
                            <div class="separator">
                                ...
                                $preference->back_urls = array(
                                    "success" => "https://www.hypedx.com.br/src/desktop/components/purchase.php",
                                    "failure" => "https://www.hypedx.com.br/src/desktop/components/purchase.php",
                                    "pending" => "https://www.hypedx.com.br/src/desktop/components/purchase.php"
                                );
                                ...
                                <div id="payment-label">
                                    ...
                                    <img style="padding: 10px;" width="400" src="https://hpdx.hypedx.com.br/assets/images/banners/mp.png" alt="">
                                </div>

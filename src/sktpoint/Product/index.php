	...
	<div id="colorlib-page">
    	...
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4">Basta clicar em "Adicionar ao carrinho"!</h2>
          </div>
        </div>
...
<style>
	...
	@media screen and (max-width: 800px){
		...
		.div-center{
			...
			<section class="container1" style="justify-content: center; display: flex; flex-direction: column;">
				<div style="display: flex; flex-direction: column;">
					<h2 class="prod-title">(Nome do produto)</h2><br>
					<img src="../images/image_1.jpg" style="width: 35%; height: 75%; border-radius: 2%; align-self: center;" class="img img-2">
				</div>
				<hr>
				<div style="justify-content: center; margin-top:8%; border:black solid 1px; border-radius: 10%; padding-bottom: 2%; padding-top: 2%;">
					<h3 style="color:#007508; text-align: center;">Preço: (Valor)</h3><br>
					<div class="div-center">
						<button class="button-skt" style="text-align: center; margin-left: 39%;">Adicionar ao Carrinho</button>
					</div>
				</div>
			</section>
